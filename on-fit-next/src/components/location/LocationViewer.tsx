...
function pickRegionLabel(res: any[]) {
  ...
  const { region_1depth_name: sidoRaw, region_2depth_name: guRaw, region_3depth_name: dongRaw} = target
...
export default function LocationViewer({ appKey, onPick }: Props) {
